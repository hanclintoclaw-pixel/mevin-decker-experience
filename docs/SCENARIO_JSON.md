    ...
    "nodes": [
      {
        ...
        "choices": [{ "label": "Open the public door", "to": "public-storefront", "testId": "logon" }]
      }
    ]
  }
}
...
3. Add or update `data/matrix-hosts/index.json` when adding a new scenario file.
...
6. Load the URL in the Decker Experience with **Fetch Scenario**, or download the file and use **Import Scenario JSON** if URL fetch is unavailable.
