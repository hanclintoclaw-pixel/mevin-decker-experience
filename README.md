...
- Scenario data: fetch wiki-hosted JSON, starting with Happy Cat at `https://hanclintoclaw-pixel.github.io/campaign-wiki/data/matrix-hosts/happy-cat-public-storefront-host.json`.
